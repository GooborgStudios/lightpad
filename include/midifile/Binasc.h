...
class Binasc {
	...
	protected:
		...
		int processMidiPitchBendWord(ostream &out, const string &input, int lineNum);
		...
		int readMidiEvent(ostream &out, istream &infile, int &trackbytes, int &command);
		int getVLV(istream &infile, int &trackbytes);
		int getWord(string &word, const string &input, const string &terminators, int index);
