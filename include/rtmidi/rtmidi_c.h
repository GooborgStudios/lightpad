...
RTMIDIAPI RtMidiInPtr rtmidi_in_create (enum RtMidiApi api, const char *clientName,
                                        unsigned int queueSizeLimit);
RTMIDIAPI void rtmidi_in_free (RtMidiInPtr device);
RTMIDIAPI enum RtMidiApi rtmidi_in_get_current_api (RtMidiPtr device);
RTMIDIAPI void rtmidi_in_set_callback (RtMidiInPtr device, RtMidiCCallback callback,
                                       void *userData);
RTMIDIAPI void rtmidi_in_cancel_callback (RtMidiInPtr device);
RTMIDIAPI void rtmidi_in_ignore_types (RtMidiInPtr device, bool midiSysex, bool midiTime,
                                       bool midiSense);
...
RTMIDIAPI int rtmidi_out_send_message (RtMidiOutPtr device, const unsigned char *message,
                                       int length);
